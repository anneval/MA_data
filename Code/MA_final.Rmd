...
# but forecast!!! done... can do manually with mine if i wanted to... can i incorpate "new older data in quarter aggregates??
#to do get dates right! grpah assign direkt ts dates.. 
# hiniken paper 
# do in month.y...no
# do daily incidcator with own github, done 

### after models  - have to check for "my" expanding window models! 
Homoskedasticity assumption
Zero-mean assumption:
No-autocorrelation assumption:
Normality assumption
structural shocks !!! cumsum still check ... 
