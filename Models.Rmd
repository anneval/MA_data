...
- AR(1) and expanding estimation  (IS and OOS) (6x) - cannot compare to others sample set, correct since incoporate predcition in new train data?
...
- Do new model with consumer google index statt economic google index? - initialise new indices..
