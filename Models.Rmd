...
VAR1_est <- VAR(y = Data[,c(1,3)], p = lag,type = "const")
...
resid_VAR1 <- data.frame(
  VAR_est1$varresult$gdp$residuals,
  VAR_est1$varresult$cci$residuals,
  VAR_est1$varresult$google$residuals)

adf.test(VAR_est1$varresult$gdp$residuals) # stationary
adf.test(VAR_est1$varresult$cci$residuals) #stationary
adf.test(VAR_est1$varresult$google$residuals)#stationary
...
```{r}
ser.test_VAR1 <- serial.test(VAR1_est) # H0: no serial correlation
ser.test_VAR1
```
...
VAR2_est <- VAR(y = Data[,c(1,3)], p = lag,type = "const")
...
resid_VAR2 <- data.frame(
  ...
  VAR2_est$varresult$cci$residuals,
  VAR2_est$varresult$google$residuals)

adf.test(VAR2_est$varresult$gdp$residuals) # stationary
adf.test(VAR2_est$varresult$cci$residuals) #stationary
